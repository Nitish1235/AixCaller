...
const S = {
  container: { display: "flex", minHeight: "100vh", background: "#F6FEFA" } as React.CSSProperties,
  sidebar: {
  ...
  brand: {
    padding: "1.5rem 1.25rem 1.25rem", display: "flex",
    alignItems: "center", gap: 10, borderBottom: "1px solid rgba(255,255,255,0.08)",
  },
  logo: { width: 34, height: 34, borderRadius: 10, background: "#10B981", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem", flexShrink: 0 },
  brandName: { fontWeight: 900, fontSize: "1rem", color: "#fff", letterSpacing: -0.3 },
  brandSub: { fontSize: "0.65rem", color: "#6EE7B7", fontWeight: 500 },
  nav: { flex: 1, padding: "1rem 0.75rem", display: "flex", flexDirection: "column" as const, gap: 2 },
  main: { marginLeft: 240, flex: 1, display: "flex", flexDirection: "column" as const, minHeight: "100vh" },
  topbar: {
    height: 60, background: "#fff", borderBottom: "1px solid #D1FAE5",
    display: "flex", alignItems: "center", justifyContent: "space-between",
    padding: "0 2rem", position: "sticky" as const, top: 0, zIndex: 40,
  },
    ...
    <div style={S.container}>
      ...
      <aside style={S.sidebar}>
        <div style={S.brand}>
          ...
          <div>
            <div style={S.brandName}>AIxCaller</div>
        ...
        {/* Credits */}
        <div style={{ padding: "1rem", margin: "0 0.75rem 1rem", background: "rgba(16,185,129,0.12)", borderRadius: 12, border: "1px solid rgba(16,185,129,0.2)" }}>
        ...
        <div style={{ padding: "0.75rem 1rem", borderTop: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 34, height: 34, borderRadius: "50%", background: "linear-gradient(135deg, #10B981, #064E3B)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, color: "#fff", fontSize: "0.9rem", flexShrink: 0 }}>U</div>
          <div style={{ flex: 1, overflow: "hidden" }}>
            <div style={{ fontWeight: 700, fontSize: "0.82rem", color: "#fff", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>My Workspace</div>
            <div style={{ fontSize: "0.7rem", color: "rgba(255,255,255,0.4)" }}>Pro Plan</div>
          </div>
          <Link href="/login" style={{ fontSize: "0.7rem", color: "rgba(255,255,255,0.3)", textDecoration: "none" }}>↩</Link>
        </div>
